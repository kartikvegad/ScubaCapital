...
export const heroContent = {
  eyebrow: "Disciplined investing for a brighter tomorrow",
  headline: "Your Wealth. Your Goals. Your Future.",
  ...
  accent: "HNI Families",
  description:
    "Personalized investment solutions. Transparent advice. A long-term partner for your financial goals.",
  quote: "Better conversations create brighter tomorrows.",
  body: [
...
export const heroHighlights = [
  { id: "goal-based", label: "Goal-Based Planning" },
  { id: "research", label: "Research-Driven Advice" },
  { id: "transparent", label: "Transparent & Unbiased" },
  { id: "partnership", label: "Long-Term Partnership" },
] as const;
...
export const pillarsIntro = {
  ...
  subtitle:
    "From wealth creation to legacy planning, we offer a comprehensive range of mutual fund solutions tailored to your goals.",
  intro: [
...
export const pillars = [
  {
    ...
    teaser:
      "Grow your wealth with disciplined, research-backed mutual fund investments.",
    items: [
  ...
  },
  {
    ...
    teaser: "Strategies to safeguard what matters most.",
    items: [
  ...
  },
  {
    ...
    teaser: "Structured plans for life's important milestones.",
    items: [
  ...
  },
  {
    ...
    teaser: "Build a lasting legacy for future generations.",
    items: [
